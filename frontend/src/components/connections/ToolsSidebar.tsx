...
export function ToolsSidebar({ onToolDragStart, onClose }: ToolsSidebarProps) {
  ...
  return (
    <div className="w-80 h-full flex flex-col">
      ...
      <div className="theme-scrollbar flex-1 overflow-y-auto px-4 pb-4">
          ...
          <div className="grid grid-cols-3 gap-2">
            {filteredTools.slice(0, 9).map((tool) => (
              <div
                ...
                title={tool.name}
              >
                <div className="text-[var(--color-text-secondary)] transition-all duration-200 group-hover:text-[#B5BAC1] group-hover:scale-110">
